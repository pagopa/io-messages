...
resource "azurerm_monitor_metric_alert" "alert_nh_partition_1_pns_errors" {

  name                = "[IOCOM|NH Partition 1] Push Notification Service errors"
  resource_group_name = var.resource_group_name

  scopes        = [azurerm_notification_hub.partition_1.id]
...
resource "azurerm_monitor_metric_alert" "alert_nh_partition_1_anomalous_pns_success_volume" {

  name                = "[IOCOM|NH Partition 1] Push Notification Service anomalous success volume"
  resource_group_name = var.resource_group_name
