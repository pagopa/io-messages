...
| [azurerm_role_assignment.message_content_container_contributor_slot](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/role_assignment) | resource |
...
| <a name="input_subnet_cidrs"></a> [subnet\_cidrs](#input\_subnet\_cidrs) | n/a | <pre>object({<br/>    notif_func   = string<br/>    citizen_func = string<br/>    etl_func     = string<br/>    ops_func     = string<br/>  })</pre> | n/a | yes |
