locals {
  ...
  etl_func = {
    app_settings = {
      ...
      MESSAGES_INGESTION_TRIGGER_LEASE_CONTAINER      = "messages-dataplan-ingestion-test-lease",
      MESSAGES_INGESTION_TRIGGER_MAX_INVOCATION_ITEMS = 50,
      MESSAGES_INGESTION_TRIGGER_MINIMUM_INTERVAL     = 1,
      MESSAGES_INGESTION_TRIGGER_MAXIMUM_INTERVAL     = 30,
      MESSAGES_INGESTION_TRIGGER_MAX_RETRY_COUNT      = 5
    }
  }
}
