...
removed {
  from = module.repo.module.github_repository.github_repository.this
  lifecycle {
    destroy = false
  }
}
...
removed {
  from = module.repo.module.github_repository.github_actions_repository_permissions.repo
  lifecycle {
    destroy = false
  }
}
...
removed {
  from = module.repo.module.github_repository.github_branch_default.main
  lifecycle {
    destroy = false
  }
}
...
removed {
  from = module.repo.module.github_repository.github_branch_protection.main
  lifecycle {
    destroy = false
  }
}
...
removed {
  from = module.repo.module.github_repository.null_resource.workflow_permissions
  lifecycle {
    destroy = false
  }
}
...
removed {
  from = module.repo.github_repository_environment.infra_cd
  lifecycle {
    destroy = false
  }
}
...
removed {
  from = module.repo.github_repository_environment.app_cd
  lifecycle {
    destroy = false
  }
}
...
removed {
  from = module.repo.github_repository_environment.opex_cd
  lifecycle {
    destroy = false
  }
}
...
removed {
  from = module.repo.github_repository_environment.infra_ci
  lifecycle {
    destroy = false
  }
}
...
removed {
  from = module.repo.github_repository_environment.opex_ci
  lifecycle {
    destroy = false
  }
}
...
removed {
  from = module.repo.github_repository_environment_deployment_policy.app_cd_branch
  lifecycle {
    destroy = false
  }
}
...
removed {
  from = module.repo.github_repository_environment_deployment_policy.infra_cd_branch
  lifecycle {
    destroy = false
  }
}
...
removed {
  from = module.repo.github_repository_environment_deployment_policy.opex_cd_branch
  lifecycle {
    destroy = false
  }
}
