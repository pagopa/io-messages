...
public class ConfigConsumer extends ConfigKafka {
  ...
  @Bean
  SenderMetadata reminderEventSenderMetadata() {
  ...
  public CommonErrorHandler commonErrorHandler() {
    CommonDelegatingErrorHandler commonDelegatingErrorHandler =
        new CommonDelegatingErrorHandler(defaultErrorHandler());
    KafkaDeserializationErrorHandler deserializationErrorHandler =
        new KafkaDeserializationErrorHandler();
    commonDelegatingErrorHandler.addDelegate(
        DeserializationException.class, deserializationErrorHandler);
    commonDelegatingErrorHandler.addDelegate(
        AvroDeserializerException.class, deserializationErrorHandler);
    commonDelegatingErrorHandler.addDelegate(SkipDataException.class, deserializationErrorHandler);
    commonDelegatingErrorHandler.addDelegate(
        UnexpectedDataException.class, deserializationErrorHandler);
  ...
  public ConcurrentKafkaListenerContainerFactory<String, Reminder> kafkaListenerContainerFactory() {
    ConcurrentKafkaListenerContainerFactory<String, Reminder> factory =
    ...
    props.put(
        ...
        AvroMessageDeserializer.class.getName());
  ...
  @Bean
  public ConcurrentKafkaListenerContainerFactory<String, messageStatus>
      kafkaListenerContainerFactoryMessStat(
          @Autowired @Qualifier("messageStatusSchema") JsonLoader mesagesStatusSchema) {
    ConcurrentKafkaListenerContainerFactory<String, messageStatus> factoryStatus =
        new ConcurrentKafkaListenerContainerFactory<>();
    ...
    props.put(
        ErrorHandlingDeserializer.VALUE_DESERIALIZER_CLASS,
        AvroMessageStatusDeserializer.class.getName());
    props.put(ErrorHandlingDeserializer.KEY_DESERIALIZER_CLASS, StringDeserializer.class);
    DefaultKafkaConsumerFactory<String, messageStatus> dkc =
  ...
  public ConcurrentKafkaListenerContainerFactory<String, PaymentMessage>
      kafkaListenerContainerFactoryPaymentMessage() {
    ConcurrentKafkaListenerContainerFactory<String, PaymentMessage> factoryStatus =
        new ConcurrentKafkaListenerContainerFactory<>();
    ...
    props.put(
        ErrorHandlingDeserializer.VALUE_DESERIALIZER_CLASS,
        PaymentMessageDeserializer.class.getName());
    props.put(ErrorHandlingDeserializer.KEY_DESERIALIZER_CLASS, StringDeserializer.class);
    DefaultKafkaConsumerFactory<String, PaymentMessage> dkc =
        new DefaultKafkaConsumerFactory<>(
            props, new StringDeserializer(), new PaymentMessageDeserializer(mapper));
    factoryStatus.setConsumerFactory(dkc);
    factoryStatus.setCommonErrorHandler(commonErrorHandler());
    return factoryStatus;
  }
  ...
  @Bean
  public ConcurrentKafkaListenerContainerFactory<String, Reminder>
      kafkaListenerContainerFactoryNotify() {
    ConcurrentKafkaListenerContainerFactory<String, Reminder> factory =
        new ConcurrentKafkaListenerContainerFactory<>();
    ...
    props.put(ConsumerConfig.KEY_DESERIALIZER_CLASS_CONFIG, ErrorHandlingDeserializer.class);
    props.put(
        ErrorHandlingDeserializer.VALUE_DESERIALIZER_CLASS, ReminderDeserializer.class.getName());
    props.put(ErrorHandlingDeserializer.KEY_DESERIALIZER_CLASS, StringDeserializer.class);
    DefaultKafkaConsumerFactory<String, Reminder> dkc =
        new DefaultKafkaConsumerFactory<>(
            props, new StringDeserializer(), new ReminderDeserializer(mapper));
    factory.setConsumerFactory(dkc);
    factory.setCommonErrorHandler(commonErrorHandler());
    return factory;
  }
