...
public class ReminderServiceImpl implements ReminderService {
    ...
    @Autowired
    it.ioapp.com.reminder.restclient.pagopaproxy.api.DefaultApi defaultApi;
    @Autowired
    it.ioapp.com.reminder.restclient.pagopaproxy.ApiClient apiClient;

    @Autowired
    it.ioapp.com.reminder.restclient.servicemessages.api.DefaultApi defaultServiceMessagesApi;

    @Autowired
    it.ioapp.com.reminder.restclient.servicemessages.ApiClient serviceMessagesApiClient;
