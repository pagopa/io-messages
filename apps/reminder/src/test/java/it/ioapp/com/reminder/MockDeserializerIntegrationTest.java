...
public class MockDeserializerIntegrationTest extends AbstractMock {
  ...
  @MockBean JsonAvroConverter converter;

  @Mock ObjectMapper mapper;

  @InjectMocks AvroMessageDeserializer avroMessageDeserializer = null;

  @InjectMocks AvroMessageStatusDeserializer avroMessageStatusDeserializer = null;

  @InjectMocks PaymentMessageDeserializer paymentMessageDeserializer = null;

  @InjectMocks ReminderDeserializer reminderDeserializer = null;
  ...
  public void test_messageDeserialize_ko() {
    Assertions.assertThrows(
        AvroDeserializerException.class,
  ...
  public void test_messageStatusDeserialize_ok() throws IOException {
    ...
    DatumWriter<messageStatus> writer = new SpecificDatumWriter<>(messageStatus.class);
    ByteArrayOutputStream bos = new ByteArrayOutputStream();
    Encoder encoder = EncoderFactory.get().binaryEncoder(bos, null);
  ...
  public void test_messageStatusDeserialize_ko() {
    Assertions.assertThrows(
        AvroDeserializerException.class,
        () ->
            avroMessageStatusDeserializer.deserialize(
                null, messageStatusSchema.getJsonString().getBytes()));
  }

  @Test
  public void test_paymentDeserialize_OK()
      throws StreamReadException, DatabindException, IOException {
    byte[] byteArrray = "".getBytes();
    paymentMessageDeserializer = new PaymentMessageDeserializer(mapper);
    Mockito.when(converter.convertToJson(Mockito.any(), Mockito.anyString()))
        .thenReturn(byteArrray);
    Mockito.when(mapper.readValue(byteArrray, PaymentMessage.class))
        .thenReturn(new PaymentMessage());
    paymentMessageDeserializer.deserialize(null, byteArrray);
    Assertions.assertTrue(true);
  }

  @Test
  public void test_paymentDeserialize_KO()
      throws StreamReadException, DatabindException, IOException {
  ...
  @Test
  public void test_reminderDeserialize_OK()
      throws StreamReadException, DatabindException, IOException {
    byte[] byteArrray = "".getBytes();
  ...
  protected void mockKafkaDeserializationErrorHandler(
      Exception unexpectedException, boolean recordIsNotNull) {
    ...
    commonErrorHandler.handleRemaining(
        unexpectedException, (List<ConsumerRecord<?, ?>>) records, consumer, null);
  }
  ...
  public void test_DeserializationException() {
    Exception deserializationException =
        new DeserializationException(
            ...
            "Deserialization Exception".getBytes(),
            false,
            new Exception());
  ...
  public void test_AvroDeserializerException() {
    Exception avroDeserializerException =
        new AvroDeserializerException(
            "Avro deserializer exception!", "Avro deserializer exception!".getBytes());
  ...
  public void test_UnexpectedDataException() {
    Exception unexpectedDataException =
        new UnexpectedDataException("Unexpected data exception!", new Object());
