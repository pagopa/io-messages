...
export enum TelemetryEventName {
  ...
  SEND_AAR_QRCODE_CHECK_DATA_NOT_FOUND = "io.com.send.aar.qrcode_check_data_not_found",
  SEND_AAR_QRCODE_CHECK_MALFORMED_403 = "io.com.send.aar.qrcode_check_malformed_403",
