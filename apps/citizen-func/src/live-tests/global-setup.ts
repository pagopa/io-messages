...
export default async function globalSetup({
  ...
  console.info("[live-tests] starting Azurite...");
  ...
  console.info(`[live-tests] Azurite ready via ${azuriteConnection.host}`);

  console.info("[live-tests] starting Cosmos emulator...");
  ...
  console.info(`[live-tests] Cosmos emulator ready via ${cosmosEndpoint}`);
  ...
  console.info("[live-tests] Function host ready");
  ...
  console.info("[live-tests] shared containers ready");
