...
export const UpdateRcConfigurationRequestSchema = z.object({
...
export type UpdateRcConfigurationRequest = z.infer<
  typeof UpdateRcConfigurationRequestSchema
>;

const toRcEnvironment = (
  environment: NonNullable<UpdateRcConfigurationRequest["prod_environment"]>,
...
export const toRcConfigurationUpdate = (
  request: UpdateRcConfigurationRequest,
