...
public class MockDeserializerIntegrationTest extends AbstractMock {
  ...
  @InjectMocks PaymentRootDeserializer paymentDeserializer = null;
  ...
  @Test
  public void test_messageDeserialize_ok()
  ...
  public void test_paymentDeserialize_KO()
    ...
    Assertions.assertThrows(
        DeserializationException.class, () -> paymentDeserializer.deserialize(null, byteArray));
  }
