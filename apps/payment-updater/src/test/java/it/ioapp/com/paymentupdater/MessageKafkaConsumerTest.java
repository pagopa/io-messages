...
public class MessageKafkaConsumerTest extends AbstractMock {
  ...
  @InjectMocks private PaymentProducer producer;
  ...
  public void test_messageEventKafkaConsumer_OK() throws Throwable {
    ...
    mockSaveWithResponse(
        selectReminderMockObject(
            ...
            "roicjre200"));
    mockGetPaymentInfo();
    messageKafkaConsumer.messageKafkaListener(
        selectReminderMockObject(
            "",
            "1",
            "PAYMENT",
  ...
  public void test_messageEventKafkaConsumer_IsPaidTrue(Payment payment, String idPaymentMessage)
      throws Throwable {
  ...
  public void test_messageEventKafkaConsumer_IsPaidFalse(Payment payment, String idPaymentMessage)
      throws Throwable {
