...
public class PaymentRetryServiceImpl implements PaymentRetryService {
  ...
  @Override
  public List<PaymentRetry> getPaymentRetryByNoticeNumberAndFiscalCode(
      String noticeNumber, String fiscalCode) {
    return paymentRetryRepository.getPaymentRetryByNoticeNumberAndFiscalCode(
        noticeNumber, fiscalCode);
  }
