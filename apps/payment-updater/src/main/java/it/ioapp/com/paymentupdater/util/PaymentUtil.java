...
public class PaymentUtil {
  ...
  public static void checkDueDateForPayment(LocalDate proxyDueDate, Payment reminder) {
    ...
    LocalDate reminderDueDate =
        reminder.getDueDate() != null ? reminder.getDueDate().toLocalDate() : null;
  ...
  public static void checkDueDateForPaymentMessage(String proxyDueDate, PaymentMessage message) {
    ...
    if (StringUtils.isNotEmpty(proxyDueDate)) {
      ...
      LocalDate reminderDueDate =
          message.getDueDate() != null ? message.getDueDate().toLocalDate() : null;
  ...
  public static LocalDateTime getCurrentTimeZone(
      LocalDateTime time, ZoneId oldZone, ZoneId newZone) {
    return Optional.ofNullable(time)
        .map(currTime -> currTime.atZone(oldZone).withZoneSameInstant(newZone).toLocalDateTime())
        .orElse(null);
  }
}
