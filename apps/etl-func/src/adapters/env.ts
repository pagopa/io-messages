...
export const envSchema = z.object({
  ...
  MESSAGES_INGESTION_RETRY_MAX_INVOCATION_ITEMS: z.coerce.number(),
  MESSAGES_INGESTION_RETRY_MAX_MINUTES_INTERVAL: z.coerce.number(),
  MESSAGES_INGESTION_RETRY_MAX_RETRIES_COUNT: z.coerce.number(),
  MESSAGES_INGESTION_RETRY_MIN_MINUTES_INTERVAL: z.coerce.number(),
