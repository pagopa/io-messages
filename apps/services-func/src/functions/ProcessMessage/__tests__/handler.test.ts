...
import { SpecialServiceCategoryEnum } from "@pagopa/io-functions-commons/dist/generated/definitions/v2/SpecialServiceCategory";
import {
  ActivationModel,
  RetrievedActivation,
  ...
  `(
    ...
    async ({
      ...
      const processMessageHandler = getProcessMessageHandler({
        ...
        lActivation,
        lBlobService: lBlobService as any,
        lMessageModel,
        lMessageStatusModel,
        lProfileModel,
